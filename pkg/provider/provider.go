...
func (p *rp10Provider) ListAllMetrics() []provider.CustomMetricInfo {
...
func (p *rp10Provider) valueFor(info provider.CustomMetricInfo) (int64, error) {
...
func (p *rp10Provider) metricFor(value int64, name types.NamespacedName, info provider.CustomMetricInfo) (*custom_metrics.MetricValue, error) {
...
// The first fetches a single metric value for one object (for example, for the object metric type in the HorizontalPodAutoscaler)
func (p *rp10Provider) GetMetricByName(name types.NamespacedName, info provider.CustomMetricInfo) (*custom_metrics.MetricValue, error) {
...
func (p *rp10Provider) GetMetricBySelector(namespace string, selector labels.Selector, info provider.CustomMetricInfo) (*custom_metrics.MetricValueList, error) {
